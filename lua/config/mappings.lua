...
vim.keymap.set("n", "<leader>s", "<Cmd>luafile ~/.config/nvim/lua/plugins/telescope/telescope-split.lua<CR>", { silent = true })
...
vim.keymap.set("n", "<leader>bg", "<Cmd>luafile ~/.config/nvim/lua/plugins/telescope/telescope-bg/telescope-bg.lua<CR>", { silent = true })
